...
- **2026-05-09** | We found that the folder names and filenames of the Skater_A c3d data for Salchow and Toeloop were mistakenly swapped. The issue has been fixed, and the corrected c3d.zip file has been re-uploaded to Google Drive.
